...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit subsubmateri {{ $subsubmateri->judul }}</h1>
        <a href="#" class="d-none d-sm-inline-block btn btn-lg btn-success shadow-sm mr-2" onclick="history.back()">
            <i class="fas fa-backward fa-sm text-white-50"></i> Detail Subsubmateri
        </a>
    </div>
    <div class="row">
        <div class="col-8">
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form action="update" method="POST" enctype="multipart/form-data">
                        @csrf
                        <p class="alert alert-warning">Icon/logo, header, judul, photo 1, paragraf 1, photo 2, dan paragraf 5 harus diisi.</p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" required value="{{ $subsubmateri->judul }}">
                            @error('judul')
                                <div class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control " name="paragraf1" rows="7" required>{{ $subsubmateri->paragraf1 }}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="paragraf2" rows="7" >{{ $subsubmateri->paragraf2 }}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Paragraf 3</label>
                            <textarea class="form-control " name="paragraf3" rows="7" >{{ $subsubmateri->paragraf3 }}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Paragraf 4</label>
                            <textarea class="form-control" name="paragraf4" rows="7" >{{ $subsubmateri->paragraf4 }}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control " name="paragraf5" rows="7" required>{{ $subsubmateri->paragraf5 }}</textarea>
                        </div>

                        <p class="alert alert-warning">Untuk Paragraf 6, 7, dan 8 boleh dikosongkan dan disii sesuai kebutuhan.</p>
                        <div class="form-group">
                            <label>Paragraf 6</label>
                            <textarea class="form-control" name="paragraf6" rows="7" >{{ $subsubmateri->paragraf6 }}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Paragraf 7</label>
                            <textarea class="form-control " name="paragraf7" rows="7" >{{ $subsubmateri->paragraf7 }}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Paragraf 8</label>
                            <textarea class="form-control" name="paragraf8" rows="7" >{{ $subsubmateri->paragraf8 }}</textarea>
                        </div>
                        <div class="d-grid">
        ...
        <div class="col">
            <div class="card shadow mb-4">
                <div class="card-body">
                    ...
                    <img src="{{ asset('keperluan/panduan-subsubmateri.png') }}" alt="" style="max-width: 480px">
                </div>
            </div>
        </div>
    </div>
