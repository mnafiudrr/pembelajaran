...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Konten Subsubmateri</h1>
    ...
    <div class="row">
        <div class="col-8">
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form action="/kontenssm" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <input type="hidden" value="{{ $subsubmateriId }}" name="subsubmateriId">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('juduldoc1') is-invalid @enderror" name="juduldoc1">
                            @error('juduldoc1')
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('juduldoc2') is-invalid @enderror" name="juduldoc2">
                            @error('juduldoc2')
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('juduldoc3') is-invalid @enderror" name="juduldoc3">
                            @error('juduldoc3')
                                <div class="invalid-feedback">
