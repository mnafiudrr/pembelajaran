    ...
    <div class="row">
        <div class="col">
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form action="/soal" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label>Soal</label>
                            <textarea class="form-control " name="soal" rows="5" required></textarea>
                        </div>

                        <div class="form-group">
                            <label>Jawaban 1</label>
                            <textarea class="form-control" name="jawaban1" rows="5" required></textarea>
                        </div>

                        <div class="form-group">
                            <label>Jawaban 2</label>
                            <textarea class="form-control" name="jawaban2" rows="5" required></textarea>
                        </div>

                        <div class="form-group">
                            <label>Jawaban 3</label>
                            <textarea class="form-control" name="jawaban3" rows="5" required></textarea>
                        </div>

                        <div class="form-group">
                            <label>Jawaban 4</label>
                            <textarea class="form-control" name="jawaban4" rows="5" required></textarea>
                        </div>

                        <div class="form-group">
                            <label>Jawaban 5</label>
                            <textarea class="form-control" name="jawaban5" rows="5" required></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('jawaban') is-invalid @enderror" name="jawaban" required>
                            @error('jawaban')
