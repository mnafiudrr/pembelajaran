...
class KontenssmController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Kontenssm::create([
            'judul' => $request->judul,
            'photo1' => 'uploads/kontenssm/'.$namafilephoto1,
            'photo2' => 'uploads/kontenssm/'.$namafilephoto2,
            'photo3' => 'uploads/kontenssm/'.$namafilephoto3,
            ...
            'doc1' => 'uploads/kontenssm/'.$namafiledoc1,
            'juduldoc2' => $request->juduldoc2,
            'doc2' => 'uploads/kontenssm/'.$namafiledoc2,
            'juduldoc3' => $request->juduldoc3,
            'doc3' => 'uploads/kontenssm/'.$namafiledoc3,
